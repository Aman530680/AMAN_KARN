    ...
    >
      <div className="container flex items-center justify-between mx-auto px-4 lg:px-8">
        ...
        <div className="hidden md:flex items-center space-x-8">
          ...
          <a
            href="/aman-karn-resume.pdf"
            download="Aman-Karn-Resume.pdf"
            className="px-4 py-2 rounded-full bg-gradient-to-r from-red-600 to-red-900 text-white text-sm font-bold uppercase tracking-wider hover:scale-105 transition-transform shadow-[0_0_15px_rgba(239,68,68,0.3)]"
          >
            Resume
          </a>
        </div>
